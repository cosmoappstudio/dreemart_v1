...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  tr: {
    ...
    artistLockedHint: "Kredi satın alarak aç",
    creditsUnit: "Kredi",
  ...
  en: {
    ...
    artistLockedHint: "Unlock with purchase",
    creditsUnit: "Credits",
  ...
  es: {
    ...
    artistLockedHint: "Desbloquear con compra",
  ...
  de: {
    ...
    artistLockedHint: "Mit Kauf freischalten",
    creditsUnit: "Credits",
